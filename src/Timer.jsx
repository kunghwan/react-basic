...
const Timer = () => {
  // 2. useState로 time 이란 변수 선언하기, 초기값60
  ...
  return (
    <div>
      ...
      <h1>{time}</h1>
      {/* 5.button 만들고 클릭했을 때 counting스위치 만들어 붙이기 글자는 counting 일때는 STOP, 아닐 때는 START라고 입력하기 */}
      <button onClick={counting ? "stop" : "start"}>버튼</button>
    </div>
  );
};
